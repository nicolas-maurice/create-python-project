...
def test_config_from_kwargs():
    ...
    config.from_kwargs(boilerplate_git_url='git@github.com:/nmvalera/boilerplate-python.git')
    assert config.author_name == 'Author Name'
    assert config.boilerplate_git_url == 'git@github.com:/nmvalera/boilerplate-python.git'
...
def test_config_from_file(config_path):
    # Test DEFAULT boilerplate
    config = Config()
